#!/usr/bin/env -S deno run --allow-net --allow-env=WP_API_URL,WP_CATEGORY,WP_PAGE,NOSTR_PRIVATE_KEY,DRY_RUN,FORCE_REPUBLISH,SYNC_MODE,NOSTR_RELAY,NOSTR_RELAYS,EXTRA_HASHTAGS,COMMUNITY_NPUBS
/**
 * inspect-mapping.ts
 *
